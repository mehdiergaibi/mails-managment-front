...
import { exportExcelArr } from "@/services/exportExcel";
...
function CouriArr<TData, TValue>({
  columns,
  data,
    ...
    <div>
      <div className="items-center justify-between py-4">
        <div className="flex items-center mb-8">
          <Input
            className="max-w-sm"
            placeholder="Filter par emmeteur"
            value={
              (table.getColumn("emmeteur")?.getFilterValue() as string) ||
              ""
            }
            onChange={(e) => {
              table.getColumn("emmeteur")?.setFilterValue(e.target.value);
            }}
          />
          <Button
            className="ml-4 hidden md:block"
            onClick={() =>
              exportExcelArr(data, "Couriers d'arrive", "Courier d'arrive")
            }
          >
            Exporter vers Excel
          </Button>
