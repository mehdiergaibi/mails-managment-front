...
import { updateMailArr } from "@/services/api";
...
const EditMail: React.FC<EditMailProps> = ({ editedMail }) => {
  ...
  const form = useForm<Input>({
    ...
    defaultValues: {
      ...
      dateArr: new Date(editedMail.dateArr),
    },
  });
  ...
  async function onSubmitHandler(data: Input) {
    try {
      ...
      await updateMailArr(editedMail._id, { ...data, dateArr: date as Date });
    } catch (error) {
